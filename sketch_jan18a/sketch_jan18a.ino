...
/*
* Name: Open Car Door
* Description: Makes Motor Activiate Given a Certain Command
* Params: 
* Returns: void
*/
  ...
  if(wifiSerial.available()>0)
  {
    ...
    if(find(message,"esp8266:"))
    {
      ...
      if(find(result,"OK"))
        ...
        sendData("\nErrRead");               //At command ERROR CODE for Failed Executing statemenr    
    }
    else if(find(message, "OPENDOOR"))
    {
    //turn on build in LED:
    digitalWrite(13, HIGH);
    //Begin interfacing with the motor:
    myStepper.step(200);
    delay(2000);
    myStepper.step(-200);
    delay(2000); 
